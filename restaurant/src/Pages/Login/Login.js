...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    // Send data to API
    fetch("https://food-delivery-two-phi.vercel.app/api/user/login", {
      method: "POST",
      headers: {
        ...
        <div className="md:w-4/5 mx-5 my-10 bg-gray-100 rounded-md shadow-2xl md:m-auto h-auto md:mb-40 md:mt-20 flex flex-col-reverse lg:flex-row justify-between">
          <div className="p-10 lg:w-1/2 lg:p-20 md:p-10">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-orange-700 text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
              >
                Submit
              </button>
